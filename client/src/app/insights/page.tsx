...
import { categories, categorySlug, formatPostDate, getAllPosts, getFeaturedPost } from "@/lib/insights";
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <Reveal delay={0.1}>
          ...
          >
            <MediaPlaceholder label="Cover image pending" className="aspect-[16/9] w-full lg:aspect-auto" />
