...
export const executiveTeam: TeamMember[] = [
  {
    ...
    summary:
      "Founder and Managing Director, leading DreamMakers' growth across Lagos and Ogun's fastest-developing corridors.",
    bio: [
      "Ejieh Paradise Godstime founded DreamMakers Real Estate to bring transparency and delivery discipline to Nigeria's property market. Based in Lekki, Lagos, he has built the company from a single plot on the Lekki–Epe corridor into a developer with an active pipeline across Lagos and Ogun State, with a focus on properties in high-growth economic areas.",
      ...
      "He holds a Bachelor of Science in Accounting and is currently pursuing a second degree at the University of Lagos. Before founding DreamMakers, he built and ran Paradise Global Enterprise, a pest-control company serving top-tier clients across Lagos State — an experience that shaped his focus on operational discipline and client service.",
  ...
  },
  {
    ...
    bio: [
      "Mary William serves as Chief Operating Officer at DreamMakers Real Estate, where she leads operational strategy and talent development across the company. A graduate of Public Administration, she brings a versatile, hands-on approach that keeps teams aligned as the company scales.",
  ...
  },
  {
    ...
    bio: [
      "Ejieh Mercy Ogho is General Manager at DreamMakers Real Estate, where she turns the company's growth strategy into daily execution. She holds a Higher National Diploma in Business Administration from Delta State Polytechnic and draws on a background in marketing and styling to combine creativity with operational rigor.",
...
export const advisoryBoard: TeamMember[] = [
  ...
  },
  {
    ...
    bio: [
      "Josh Diamond brings over a decade of experience in digital media, marketing, and sales to DreamMakers' Advisory Board. As Group Head of Sales & Digital Media for Silverbird Group — one of Africa's leading entertainment conglomerates — he has led campaigns for brands including MTN Nigeria, Access Bank, and Janssen Pharmaceuticals, working across a marketing network of more than 320 partners.",
      "At DreamMakers, Josh advises on digital strategy and brand positioning, helping the company reach investors and homebuyers across its target markets.",
    ],
  },
  {
    slug: "oliver-eyah",
    ...
    bio: [
      "Oliver Eyah is a Senior Associate and Attorney with more than ten years of experience in commercial law, real estate, and regulatory compliance. He advises DreamMakers on contract structuring, dispute resolution, and financial risk.",
